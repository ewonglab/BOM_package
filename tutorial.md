...
In this step, the motif counts matrix will be prepared for binary classification, by running <code>matrix_binModel</code> function. This functions requires the fimo.tsv output generated in previous step.


Required arguments for this function include

- 'target_ct'   : The directory name (i.e cell type ) as generated by fimo in previous step. If null then will search in data_path for all motif directory outputs and process them all.
